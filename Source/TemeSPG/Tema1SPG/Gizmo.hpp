...
private:
	...
	BaseMesh* generateGizmoCone()
	{
		...
		{
			glm::vec3 vcrt = glm::vec3(glm::rotate(glm::mat4(1), glm::radians(angle), glm::vec3(0, 1, 0)) * glm::vec4(1, 7.59, 0, 1));
			glm::vec3 vnext = glm::vec3(glm::rotate(glm::mat4(1), glm::radians(angle + step), glm::vec3(0, 1, 0)) * glm::vec4(1, 7.59, 0, 1));
